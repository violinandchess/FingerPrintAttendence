...
public class FTPUtility {
    ...
    private StoredAttendenceFileService fileinsert;
    public FTPUtility(String host, int port, String user, String pass) {
        this.host = host;
        this.port = port;
        this.username = user;
        this.password = pass;
        fileinsert=new StoredAttendenceFileService();
    }
     ...
     */
    public void uploadFile(File uploadFile, String destDir,String startingDate,String endingDate) throws FTPException {
        try {
...
//          FileInputStream   uploadnewfile = new FileInputStream(uploadFile);
//           ftpClient.storeFile(newFileName, uploadnewfile);
            outputStream = ftpClient.storeFileStream(newFileName);
            //ftpClient.storeFile(uploadFile.getName(),   new FileInputStream(uploadFile));
            if(!fileinsert.AddAttendenceFile(newFileName,startingDate,endingDate))
            {
                 
            JOptionPane.showMessageDialog(null,
                    "File has been uploaded successfully Unable To store Path!", "Message",
